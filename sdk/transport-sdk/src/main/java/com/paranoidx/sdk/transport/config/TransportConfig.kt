package com.paranoidx.sdk.transport.config
...
object TransportConfig {
    ...
    @Volatile private var instance: TransportConfig? = null
    ...
    fun getInstance(ctx: Context): TransportConfig {
        return instance ?: synchronized(this) {
            instance ?: TransportConfig().also { 
                it.context = ctx.applicationContext
                instance = it
            }
        }
    }
